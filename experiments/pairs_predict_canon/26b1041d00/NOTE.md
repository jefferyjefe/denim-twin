...
- cut: inseam fraction **0.428** — removes 16% of the garment
- state: **after_cut**
...
flags: mask score 1.004, area 0.44 of frame; landmark heuristic calls this 'shorts', not full-length jeans: a shorter->shorter cut
