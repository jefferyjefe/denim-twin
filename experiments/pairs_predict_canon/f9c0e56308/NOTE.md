...
- cut: inseam fraction **0.042** — removes 53% of the garment
...
flags: mask score 0.993, area 0.43 of frame; fringe prior has only n=3 samples: the depth below is not yet evidence-backed
