...
flags: coin scale rejected: no coin-like circle found; wash preset median: shrink 2.0% along / 1.0% across (PRIOR, not measured); 1305465 px changed
...
|---|---|---|---|---|
| pred conservative | 0.854 | 45.3 | 24.3 | 0.086 |
| pred median | 0.861 | 43.3 | 23.6 | 0.220 |
| pred aggressive | 0.864 | 42.7 | 23.2 | 0.301 |
