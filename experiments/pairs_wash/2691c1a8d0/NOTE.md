...
flags: after: rotated -8.8° to upright; wash preset median: shrink 2.0% along / 1.0% across (PRIOR, not measured); 73151 px changed; fringe measured directly: 4.0px in the after frame (rel 0.0105, coverage 1.00); SAM/hem-fit said 2.2px; no fringe rendered: edge_treatment 'raw' with no wash does not fray (EXP_0017)
...
|---|---|---|---|---|
| pred conservative | 0.739 | 12.5 | 17.5 | 0.000 |
| pred median | 0.739 | 12.5 | 17.5 | 0.000 |
| pred aggressive | 0.739 | 12.4 | 17.6 | 0.000 |
