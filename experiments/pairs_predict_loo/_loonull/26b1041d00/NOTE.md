...
- cut: inseam fraction **0.260** — removes 23% of the garment
- state: **after_cut**
...
Outside the cut region, 0.9% of kept pixels differ from the input photo (a strict pixel copy: only the abraded band at the cut edge).
