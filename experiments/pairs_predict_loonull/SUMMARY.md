...
| 4bfef03bd7 | after_wash | 0.789 | 0.807 | 0.789 | 11.5 | 4.5 |
| 8d9f0df4ad | after_cut | 0.882 | 0.958 | 0.883 | 38.5 | 3.2 |
| e97924ad2d | after_cut | 0.864 | 0.893 | 0.864 | 7.5 | 1.3 |

**mean over 7 pairs** — product IoU 0.823, evaluation IoU 0.857, crop-only IoU 0.823; product hem 20.9 px, evaluation hem 7.8 px
...
**independent (leave-one-out) null** — product IoU 0.8232, LOO-null IoU 0.7278, advantage **+0.0954**, product wins 6 of 7
