...
- cut: inseam fraction **0.061**, angle -14.4° — removes 55% of the garment
- state: **after_cut**
...
flags: mask score 0.910, area 0.45 of frame; legs reach the frame bottom: the original hem is out of frame, so an inseam fraction is measured against the frame, not the hem; angled cut -14.4°: inner fraction 0.061, outer 0.122
