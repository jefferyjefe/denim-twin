...
flags: before: rotated -15.2° to upright; after: rotated -3.0° to upright; direct fringe measurement failed (577 columns); falling back to the SAM/hem-fit value 9.0px; no fringe rendered: edge_treatment 'raw' with no wash does not fray (EXP_0017)
before: /Users/jefferyhuang/denim-twin/experiments/pairs_prefringegate/963fcdd264/cropped_before.png 
...
|---|---|---|---|---|
| pred conservative | 0.527 | 10.5 | 27.2 | 0.012 |
| pred median | 0.527 | 10.5 | 27.2 | 0.016 |
| pred aggressive | 0.529 | 10.2 | 27.2 | 0.036 |
