...
hem fit: left: angle -20.9°, depth 1 px, right: angle 6.3°, depth 0 px
registration residual (leave-one-landmark-out): 47.58px

| system | sil IoU | chamfer | edge ΔE | fringe IoU |
|---|---|---|---|---|
| pred conservative | 0.736 | 11.4 | 18.5 | 0.003 |
| pred median | 0.736 | 11.4 | 18.5 | 0.003 |
| pred aggressive | 0.736 | 11.4 | 18.5 | 0.024 |
| null:no-op | 0.577 | 171.5 | 20.2 | 0.020 |
| null:crop-only | 0.736 | 11.4 | 18.4 | 0.000 |
