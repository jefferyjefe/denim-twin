...
hem fit: left: angle -19.6°, depth 0 px, right: angle 14.2°, depth 1 px
registration residual (leave-one-landmark-out): 76.77px

| system | sil IoU | chamfer | edge ΔE | fringe IoU |
|---|---|---|---|---|
| pred conservative | 0.817 | 27.3 | 16.6 | 0.000 |
| pred median | 0.817 | 27.3 | 16.6 | 0.000 |
| pred aggressive | 0.817 | 27.3 | 16.6 | 0.043 |
| null:no-op | 0.664 | 113.1 | 22.7 | 0.011 |
| null:crop-only | 0.817 | 26.8 | 16.5 | 0.000 |
