...
flags: after: rotated 2.1° to upright; SAM fringe mask rejected: median depth 44px > 15% of garment height 269px; before garment is short (bermuda/shorts): a short->shorter cut, not jeans->shorts; direct fringe measurement failed (350 columns); falling back to the SAM/hem-fit value 0.0px; no fringe rendered: edge_treatment 'cuffed' with no wash does not fray (EXP_0017)
...
hem fit: left: angle 13.0°, depth 0 px, right: angle -9.5°, depth 0 px
registration residual (leave-one-landmark-out): 11.21px

| system | sil IoU | chamfer | edge ΔE | fringe IoU |
|---|---|---|---|---|
| pred conservative | 0.899 | 3.0 | 24.2 | 0.017 |
| pred median | 0.899 | 3.0 | 24.2 | 0.030 |
| pred aggressive | 0.899 | 3.1 | 24.2 | 0.053 |
