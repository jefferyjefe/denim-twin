...
- cut: inseam fraction **0.213** — removes 49% of the garment
- state: **after_cut**
...
Outside the cut region, 1.3% of kept pixels differ from the input photo (a strict pixel copy: only the abraded band at the cut edge).
