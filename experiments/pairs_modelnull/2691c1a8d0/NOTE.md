...
- cut: inseam fraction **0.457** — removes 17% of the garment
- state: **after_cut**
...
Outside the cut region, 0.1% of kept pixels differ from the input photo (a strict pixel copy: only the abraded band at the cut edge).
