...
- cut: inseam fraction **0.199** — removes 25% of the garment
- state: **after_cut**
...
Outside the cut region, 1.0% of kept pixels differ from the input photo (a strict pixel copy: only the abraded band at the cut edge).
