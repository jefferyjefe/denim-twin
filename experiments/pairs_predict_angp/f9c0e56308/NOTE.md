...
- cut: inseam fraction **0.042**, angle +7.0° — removes 57% of the garment
...
flags: mask score 0.993, area 0.43 of frame; angled cut +7.0°: inner fraction 0.042, outer 0.013; fringe prior has only n=3 samples: the depth below is not yet evidence-backed
