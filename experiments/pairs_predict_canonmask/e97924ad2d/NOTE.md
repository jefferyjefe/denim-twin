...
- cut: inseam fraction **0.725** — removes 41% of the garment
- state: **after_cut**
...
Outside the cut region, 1.2% of kept pixels differ from the input photo (a strict pixel copy: only the abraded band at the cut edge).
