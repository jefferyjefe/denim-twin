...
- cut: inseam fraction **0.346** — removes 40% of the garment
- state: **after_cut**
...
flags: mask score 0.994, area 0.46 of frame; legs reach the frame bottom: the original hem is out of frame, so an inseam fraction is measured against the frame, not the hem
