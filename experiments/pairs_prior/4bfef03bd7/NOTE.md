...
fringe depth used: 17.4 px from prior[after_wash] (n=2 after excluding self, INSUFFICIENT); measured on after-photo: 36.5 px (fabric/fringe split: SAM; after-frame)
...
|---|---|---|---|---|
| pred conservative | 0.757 | 18.8 | 23.2 | 0.092 |
| pred median | 0.764 | 16.7 | 23.1 | 0.211 |
| pred aggressive | 0.768 | 15.5 | 22.8 | 0.286 |
