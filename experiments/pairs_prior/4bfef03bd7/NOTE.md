...
fringe depth used: 2.7 px from prior[after_wash] (n=7 after excluding self); measured on after-photo: 2.2 px (fabric/fringe split: SAM; after-frame)
...
|---|---|---|---|---|
| pred conservative | 0.752 | 20.7 | 23.4 | 0.014 |
| pred median | 0.753 | 20.2 | 23.4 | 0.033 |
| pred aggressive | 0.755 | 19.5 | 23.3 | 0.064 |
