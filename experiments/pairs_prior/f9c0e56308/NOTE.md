...
fringe depth used: 5.2 px from prior[after_wash] (n=8 after excluding self); measured on after-photo: 8.7 px (fabric/fringe split: colour split; registered-frame)
...
| pred median | 0.918 | 35.4 | 18.1 | 0.082 |
| pred aggressive | 0.917 | 36.0 | 18.3 | 0.099 |
