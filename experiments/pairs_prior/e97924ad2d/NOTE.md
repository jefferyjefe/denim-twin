...
fringe depth used: 0.0 px from prior[after_cut] (n=3 after excluding self, INSUFFICIENT); measured on after-photo: 1.0 px (fabric/fringe split: colour split; registered-frame)
...
| pred median | 0.897 | 7.0 | 11.2 | 0.233 |
| pred aggressive | 0.895 | 7.3 | 11.3 | 0.225 |
