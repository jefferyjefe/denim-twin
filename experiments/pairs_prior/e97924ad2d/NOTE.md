...
fringe depth used: 0.0 px from prior[after_cut] (n=4 after excluding self, INSUFFICIENT); measured on after-photo: 1.0 px (fabric/fringe split: colour split; registered-frame)
