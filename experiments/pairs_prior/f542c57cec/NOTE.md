...
fringe depth used: 4.1 px from prior[after_wash] (n=6 after excluding self); measured on after-photo: 3.9 px (fabric/fringe split: colour split; registered-frame)
...
|---|---|---|---|---|
| pred conservative | 0.858 | 49.9 | 28.8 | 0.049 |
| pred median | 0.859 | 49.5 | 28.8 | 0.104 |
| pred aggressive | 0.860 | 49.2 | 28.8 | 0.171 |
