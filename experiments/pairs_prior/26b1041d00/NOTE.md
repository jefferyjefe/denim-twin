...
fringe depth used: 0.0 px from prior[after_cut] (n=2 after excluding self, INSUFFICIENT); measured on after-photo: 45.0 px (fabric/fringe split: SAM; after-frame)
