...
fringe depth used: 0.5 px from prior[after_cut] (n=4 after excluding self, INSUFFICIENT); measured on after-photo: 45.0 px (fabric/fringe split: SAM; after-frame)
...
| pred aggressive | 0.688 | 46.0 | 34.7 | 0.003 |
