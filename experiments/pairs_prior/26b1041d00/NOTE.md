...
flags: SAM fringe mask rejected: median depth 45px > 15% of garment height 274px; before garment is short (bermuda/shorts): a short->shorter cut, not jeans->shorts
...
fringe depth used: 0.5 px from prior[after_cut] (n=4 after excluding self, INSUFFICIENT); measured on after-photo: 0.0 px (fabric/fringe split: colour split; registered-frame)
...
| pred aggressive | 0.888 | 2.8 | 24.3 | 0.102 |
