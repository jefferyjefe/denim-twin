...
fringe depth used: 1.5 px from prior[after_cut] (n=3 after excluding self, INSUFFICIENT); measured on after-photo: 21.2 px (fabric/fringe split: SAM; after-frame)
hem fit: left: angle 14.1°, depth 7, right: angle -14.8°, depth 1
registration residual (leave-one-landmark-out): 31.22px

| system | sil IoU | chamfer | edge ΔE | fringe IoU |
|---|---|---|---|---|
| pred conservative | 0.944 | 8.5 | 21.2 | 0.030 |
| pred median | 0.944 | 8.3 | 21.2 | 0.055 |
| pred aggressive | 0.944 | 8.2 | 21.2 | 0.097 |
