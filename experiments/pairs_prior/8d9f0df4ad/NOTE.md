...
fringe depth used: 1.5 px from prior[after_cut] (n=4 after excluding self, INSUFFICIENT); measured on after-photo: 1.9 px (fabric/fringe split: SAM; after-frame)
...
|---|---|---|---|---|
| pred conservative | 0.944 | 8.8 | 21.2 | 0.030 |
| pred median | 0.944 | 8.6 | 21.2 | 0.055 |
| pred aggressive | 0.944 | 8.5 | 21.2 | 0.097 |
