...
fringe depth used: 61.4 px from prior[after_cut] (n=2 after excluding self, INSUFFICIENT); measured on after-photo: 4.0 px (fabric/fringe split: SAM)
hem fit: left: angle 14.1°, depth 7, right: angle -14.8°, depth 1
registration residual (leave-one-landmark-out): 31.22px

| system | sil IoU | chamfer | edge ΔE | fringe IoU |
|---|---|---|---|---|
| pred conservative | 0.944 | 8.8 | 21.0 | 0.318 |
| pred median | 0.934 | 15.2 | 21.0 | 0.335 |
| pred aggressive | 0.919 | 24.8 | 21.3 | 0.267 |
