...
fringe depth used: 0.0 px from prior[after_cut] (n=4 after excluding self, INSUFFICIENT) [suppressed: finished hem]; measured on after-photo: 2.6 px (fabric/fringe split: SAM; after-frame)
...
|---|---|---|---|---|
| pred conservative | 0.944 | 8.8 | 21.2 | 0.027 |
| pred median | 0.944 | 8.8 | 21.2 | 0.035 |
| pred aggressive | 0.944 | 8.6 | 21.2 | 0.070 |
