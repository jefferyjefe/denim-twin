...
fringe depth used: 0.0 px from prior[after_cut] (n=5 after excluding self) [suppressed: finished hem]; measured on after-photo: 3.1 px (fabric/fringe split: colour split; registered-frame)
