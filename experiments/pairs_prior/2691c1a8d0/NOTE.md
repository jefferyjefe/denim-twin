...
fringe depth used: 0.6 px from prior[after_cut] (n=5 after excluding self); measured on after-photo: 3.1 px (fabric/fringe split: colour split; registered-frame)
...
| pred aggressive | 0.617 | 46.6 | 16.8 | 0.037 |
