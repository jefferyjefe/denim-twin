...
fringe depth used: 0.8 px from prior[after_cut] (n=5 after excluding self); measured on after-photo: 8.4 px (fabric/fringe split: colour split; registered-frame)
...
| pred median | 0.490 | 318.5 | 18.8 | 0.004 |
| pred aggressive | 0.490 | 316.7 | 18.8 | 0.009 |
