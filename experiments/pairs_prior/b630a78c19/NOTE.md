...
fringe depth used: 0.8 px from prior[after_cut] (n=4 after excluding self, INSUFFICIENT); measured on after-photo: 307.2 px (fabric/fringe split: SAM; after-frame)
...
| pred aggressive | 0.459 | 367.5 | 17.4 | 0.002 |
