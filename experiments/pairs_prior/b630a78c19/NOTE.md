...
fringe depth used: 0.6 px from prior[after_cut] (n=5 after excluding self); measured on after-photo: 307.2 px (fabric/fringe split: SAM; after-frame)
...
|---|---|---|---|---|
| pred conservative | 0.459 | 260.9 | 17.4 | 0.001 |
| pred median | 0.459 | 260.8 | 17.4 | 0.001 |
| pred aggressive | 0.459 | 260.7 | 17.4 | 0.002 |
