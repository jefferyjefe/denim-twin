...
fringe depth used: 0.8 px from prior[after_cut] (n=4 after excluding self, INSUFFICIENT); measured on after-photo: 1.9 px (fabric/fringe split: colour split; registered-frame)
...
| pred median | 0.918 | 8.9 | 18.2 | 0.015 |
| pred aggressive | 0.918 | 9.0 | 18.3 | 0.038 |
