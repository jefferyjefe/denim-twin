...
fringe depth used: 0.0 px from prior[after_cut] (n=2 after excluding self, INSUFFICIENT); measured on after-photo: 7.8 px (fabric/fringe split: colour split; registered-frame)
...
| pred median | 0.918 | 13.4 | 18.2 | 0.013 |
| pred aggressive | 0.918 | 13.4 | 18.2 | 0.020 |
