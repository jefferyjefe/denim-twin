...
fringe depth used: 0.0 px from prior[after_cut] (n=4 after excluding self, INSUFFICIENT) [suppressed: finished hem]; measured on after-photo: 2.0 px (fabric/fringe split: SAM; after-frame)
