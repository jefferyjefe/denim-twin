...
fringe depth used: 0.7 px from prior[after_cut] (n=4 after excluding self, INSUFFICIENT); measured on after-photo: 2.0 px (fabric/fringe split: SAM; after-frame)
...
| pred median | 0.847 | 3.8 | 15.6 | 0.050 |
| pred aggressive | 0.847 | 3.9 | 15.6 | 0.093 |
