...
fringe depth used: 0.6 px from prior[after_cut] (n=4 after excluding self, INSUFFICIENT); measured on after-photo: 8.1 px (fabric/fringe split: SAM; after-frame)
...
| pred median | 0.847 | 3.8 | 15.6 | 0.047 |
| pred aggressive | 0.847 | 3.9 | 15.6 | 0.085 |
