...
- cut: inseam fraction **0.340**, angle -22.7° — removes 41% of the garment
- state: **after_cut**
...
flags: mask score 0.994, area 0.46 of frame; legs reach the frame bottom: the original hem is out of frame, so an inseam fraction is measured against the frame, not the hem; angled cut -22.7°: inner fraction 0.291, outer 0.389
