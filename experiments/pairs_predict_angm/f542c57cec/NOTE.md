...
- cut: inseam fraction **0.000**, angle -34.4° — removes 26% of the garment
...
flags: mask score 0.974, area 0.47 of frame; landmark heuristic calls this 'shorts', not full-length jeans: a shorter->shorter cut; angled cut -34.4°: inner fraction 0.000, outer 0.161; fringe prior has only n=3 samples: the depth below is not yet evidence-backed
