...
fringe depth used: 4.0 px from measured from after-photo (NOT a prediction); measured on after-photo: 4.0 px (fabric/fringe split: colour split; registered-frame)
hem fit: left: angle 9.1°, depth 0 px, right: angle -9.5°, depth 0 px
registration residual (leave-one-landmark-out): 14.59px

| system | sil IoU | chamfer | edge ΔE | fringe IoU |
|---|---|---|---|---|
| pred conservative | 0.888 | 2.8 | 24.3 | 0.078 |
| pred median | 0.887 | 3.0 | 24.3 | 0.167 |
| pred aggressive | 0.887 | 3.1 | 24.3 | 0.229 |
