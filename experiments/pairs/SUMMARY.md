...
|---|---|---|---|---|---|---|---|
| b630a78c19 | How To Make Jeans Into Shorts The Easy W | after_cut | ok | 0.56 / 0.56 / 0.53 | 242 / 244 | 16.0 / 16.0 | 0.22 / 0.17 |
| 660bef67bf | Cómo hacer shorts con jeans viejos | after_cut | FAIL: REJECT: after: widest top row is not a single waistband run  | | | | |
| 85d48013a2 | Tutorial: Aus Lang mach Kurz – Jeanshose | after_cut | FAIL: REJECT: degenerate cut: removed fraction 0.81 | | | | |
