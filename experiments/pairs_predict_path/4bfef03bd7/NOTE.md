...
- cut: inseam fraction **0.000** — removes 65% of the garment
...
Outside the cut region, 0.8% of kept pixels differ from the input photo (a strict pixel copy: only the abraded band at the cut edge).
